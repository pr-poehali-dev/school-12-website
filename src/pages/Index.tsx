...
const TEACHERS = [
  { name: 'Межова Светлана Витальевна', role: 'Директор школы', subject: 'Руководство' },
  { name: 'Иванова Ольга Петровна', role: 'Учитель высшей категории', subject: 'Математика' },
  { name: 'Соколов Андрей Николаевич', role: 'Учитель первой категории', subject: 'Физика' },
  { name: 'Кузнецова Елена Сергеевна', role: 'Учитель высшей категории', subject: 'Русский язык и литература' },
  { name: 'Морозов Дмитрий Викторович', role: 'Учитель первой категории', subject: 'История и обществознание' },
  { name: 'Васильева Наталья Игоревна', role: 'Учитель высшей категории', subject: 'Английский язык' },
];
            ...
            {TEACHERS.map((t) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-school-blue">{t.subject}</div>
